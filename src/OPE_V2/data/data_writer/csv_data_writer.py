...
class CSVDataWriter:
    ...
    METADATA = {
        ...
        'ORDER' : ['BacktestId', 'OrderId', 'OrderEventTimestamp', 'OrderEventType',
                   'OrderSide', 'OrderLevel','OrderAssetQty', 'OrderValue', 'OrderLeverage',
        ...
        'POSITION' : ['BacktestId', 'PositionId', 'OrderId', 'PositionEventTimestamp', 'PositionEventType', 
                      'PositionSide', 'PositionMargin', 'PositionEntryPrice', 'PositionAssetQty', 'PositionEntryValue', 'PositionLeverage', 
                      'PositionTakeprofitPrice', 'PositionStoplossPrice', 
                      'PositionClosePrice', 'PositionCloseValue', 'PositionClosePnl', 'PositionCloseType', 'OperationalTimestamp'],
